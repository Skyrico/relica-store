    ...
    <main className="min-h-screen p-4 flex flex-col items-center">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10 max-w-2xl mx-auto w-fit">
        {tcgRows.map((tcg) => (
          <div
            key={tcg.name}
            className="w-full max-w-xs mx-auto bg-zinc-900 border border-purple-600/40 rounded-lg p-3 flex items-center justify-center shadow-md hover:shadow-purple-500/40 hover:scale-[1.03] hover:ring-2 ring-purple-600/40 transition-all duration-200"
          >
            <Image
              src={tcg.src}
              alt={tcg.name}
